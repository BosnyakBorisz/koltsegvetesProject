...
namespace koltsegvetesAlkalmazas
{
    public partial class registerForm : Form
    {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            {
                // Duplikált kulcs (username vagy email)
        ...
        private void chkShowPassReg1_CheckedChanged(object sender, EventArgs e)
        {
            bool show = chkShowPassReg1.Checked;
            txtRegPass1.UseSystemPasswordChar = !show;
        }

        private void chkShowPassReg2_CheckedChanged(object sender, EventArgs e)
        {
